...
<html lang="pt-br">
  ...
  <body class="text-center">
    <form class="form-signin" method="post" action="/chamados/login/check">
      ...
      <img class="mb-4" src="/chamados/resources/img/Ghost_1.png" alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">Java - JSP</h1>
      ...
      <p class="mt-5 mb-3 text-muted">&copy; Elton Luiz</p>
    </form>
  </body>
